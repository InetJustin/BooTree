...
bt.core = {
     ...
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.parseDate('02/03/17', 'mm/dd/yy'));
     * </script>
     * @example String.2
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.parseDate('2017 2.3', 'yyyy m.d'));
     * </script>
     * @example String.dd.mmm.yyyy
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.parseDate('05 Feb 2017', 'dd mmm yyyy'));
     * </script>
     * @example String.dd.mmmm.yyyy
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.parseDate('05 February 2017', 'dd mmmm yyyy'));
     * </script>
     * @example String.HH:MM
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.parseDate('10:57', 'HH:MM'));
     * </script>
     * @example ASP.NET.JSON.Date
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.parseDate("\/Date(349653600000)\/"));
     * </script>
     * @example UNIX.Timestamp
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.parseDate(349653600000));
     * </script>
     */
     ...
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.formatDate(new Date(2017, 1, 3), 'mm/dd/yy'));
     * </script>
     * @example Sample.2
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.formatDate(new Date(2017, 1, 3), 'yyyy m.d'));
     * </script>
     * @example Sample.dd.mmm.yyyy
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.formatDate(new Date(2017, 1, 3), 'dd mmm yyyy'));
     * </script>
     * @example Sample.dd.mmmm.yyyy
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.formatDate(new Date(2017, 1, 3), 'dd mmmm yyyy'));
     * </script>
     * @example Sample.5
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.formatDate(new Date(2017, 1, 3, 20, 43, 53), 'hh:MM:ss tt mm/dd/yyyy'));
     * </script>
     * @example Sample.6
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.formatDate(new Date(2017, 1, 3, 20, 43, 53), 'hh:MM TT'));
     * </script>
     * @example Short.WeekDay
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.formatDate(new Date(2017, 1, 3), 'ddd, mmm dd'));
     * </script>
     * @example Full.WeekDay
     * <div id="date"></div>
     * <script>
     *     $('#date').text(bt.core.formatDate(new Date(2017, 1, 3), 'dddd, mmm dd'));
     * </script>
     */
...
bt.dialog.config = {
    base: {
         ...
         *         <button onclick="dialog.close()" class="bt-button-md">Ok</button>
         *         <button onclick="dialog.close()" class="bt-button-md">Cancel</button>
         *     </div>
         * </div>
         * <script>
         *     var dialog = $("#dialog").dialog({
         ...
         * <div id="dialog">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</div>
         * <script>
         *     bt.dialog.messages['fr-fr'].DefaultTitle = 'Titre de la boîte de dialogue';
         *     $("#dialog").dialog({
         *         resizable: true,
         *         locale: 'fr-fr',
         *         width: 700
         ...
         *   </div>
         *   <div data-role="footer">
         *     <button class="bt-button-md" onclick="dialog.close()">OK</button>
         *     <button class="bt-button-md" data-role="close">Cancel</button>
         *   </div>
         * </div>
         * <script>
         *     var dialog = $("#dialog").dialog({
...
bt.dialog.events = {
     ...
     * <div id="dialog" style="display: none">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</div>
     * <button onclick="dialog.open()" class="bt-button-md">Open Dialog</button>
     * <script>
     *     var dialog = $("#dialog").dialog({
     *         autoOpen: false,
...
bt.dialog.methods = {
    ...
    renderHeader: function ($dialog) {
        ...
        if ($closeButton.length === 0 && data.closeButtonInHeader) {
            $closeButton = $('<button type="button" data-role="close" title="' + bt.dialog.messages[data.locale].Close + '"><span>×</span></button>');
    ...
    resizable: function ($dialog) {
        ...
        $dialog.append($('<div class="bt-resizable-handle bt-resizable-n"></div>').draggable($.extend(true, { horizontal: false }, config)));
        $dialog.append($('<div class="bt-resizable-handle bt-resizable-e"></div>').draggable($.extend(true, { vertical: false }, config)));
        $dialog.append($('<div class="bt-resizable-handle bt-resizable-s"></div>').draggable($.extend(true, { horizontal: false }, config)));
        $dialog.append($('<div class="bt-resizable-handle bt-resizable-w"></div>').draggable($.extend(true, { vertical: false }, config)));
        $dialog.append($('<div class="bt-resizable-handle bt-resizable-ne"></div>').draggable($.extend(true, {}, config)));
        $dialog.append($('<div class="bt-resizable-handle bt-resizable-nw"></div>').draggable($.extend(true, {}, config)));
        $dialog.append($('<div class="bt-resizable-handle bt-resizable-sw"></div>').draggable($.extend(true, {}, config)));
        $dialog.append($('<div class="bt-resizable-handle bt-resizable-se"></div>').draggable($.extend(true, {}, config)));
    },
...
bt.dialog.widget = function ($element, jsConfig) {
     ...
     * <div id="dialog" style="display: none">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</div>
     * <button onclick="dialog.open('Custom Text')" class="bt-button-md">Open Dialog</button>
     * <script>
     *     var dialog = $('#dialog').dialog({
     *         autoOpen: false
     *     });
     ...
     * <div id="dialog" style="display: none">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</div>
     * <button onclick="dialog.open()" class="bt-button-md">Open Dialog</button>
     * <button onclick="dialog.close()" class="bt-button-md">Close Dialog</button>
     * <script>
     *     var dialog = $('#dialog').dialog();
     * </script>
     */
     ...
     * <button onclick="dialog.open()" class="bt-button-md">Open Dialog</button>
     * <button onclick="dialog.close()" class="bt-button-md">Close Dialog</button>
     * <button onclick="alert($('#dialog').dialog('isOpen'))" class="bt-button-md">isOpen</button>
     * <script>
     *     var dialog = $('#dialog').dialog();
     * </script>
     */
     ...
     * <div id="dialog" style="display: none">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</div>
     * <button onclick="create()" class="bt-button-md">Create</button>
     * <button onclick="dialog.destroy()" class="bt-button-md">Destroy</button>
     * <script>
     *     var dialog;
     *     function create() { 
     ...
     * <div id="dialog" style="display: none">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</div>
     * <button onclick="create()" class="bt-button-md">Create</button>
     * <button onclick="dialog.destroy(false)" class="bt-button-md">Destroy</button>
     * <script>
     *     var dialog;
     *     function create() {
     *         if ($('#dialog').length === 0) {
...
bt.draggable.events = {
     ...
     * .element { border: 1px solid #999; width: 300px; height: 200px; cursor: move; text-align: center; background-color: #DDD; }
     * </style>
     * <div id="element" class="element bt-unselectable">drag me</div>
     * <script>
     *     $('#element').draggable({
     ...
     * .element { border: 1px solid #999; width: 300px; height: 200px; cursor: move; text-align: center; background-color: #DDD; }
     * </style>
     * <div id="element" class="element bt-unselectable">
     *   drag me
     * </div>
     * <script>
     *     $('#element').draggable({
...
bt.draggable.widget = function ($element, jsConfig) {
    ...
    if (!$element.destroy) {
         ...
         * .element { border: 1px solid #999; width: 300px; height: 200px; cursor: move; text-align: center; background-color: #DDD; }
         * </style>
         * <button onclick="dragEl.destroy()" class="bt-button-md">Destroy</button>
         * <div id="element" class="element">Drag Me</div>
         * <script>
...
bt.droppable.widget = function ($element, jsConfig) {
     ...
     * <button onclick="create()" class="bt-button-md">Create</button>
     * <button onclick="dropEl.destroy()" class="bt-button-md">Destroy</button>
     * <br/><br/>
     * <style>
     * .draggable { border: 1px solid #999; width: 300px; height: 200px; text-align: center; }
     * .droppable { border: 1px solid #999; width: 300px; height: 200px; text-align: center; }
...
bt.grid.config = {
    base: {
         ...
         * <table id="grid"></table>
         * <script>
         *     bt.grid.messages['fr-fr'].DisplayingRecords = 'Mes résultats';
         *     $('#grid').grid({
         *         dataSource: '/Players/Get',
         *         uiLibrary: 'materialdesign',
         *         locale: 'fr-fr',
    ...
    materialicons: {
        icons: {
            asc: '<i class="bt-icon arrow-upward" />',
            desc: '<i class="bt-icon arrow-downward" />'
        }
    },
...
bt.grid.events = {
     ...
     * @param {object} record - the data of the row record
     * @example sample <!-- grid -->
     * <button onclick="grid.removeRow('1')" class="bt-button-md">Remove Row</button><br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid = $('#grid').grid({
     *         primaryKey: 'ID',
     ...
     * @param {object} e - event data
     * @example sample <!-- grid -->
     * <button id="btnDestroy" class="bt-button-md">Destroy</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid = $('#grid').grid({
...
bt.grid.methods = {
    ...
    updateHeader: function ($grid) {
        ...
        if (sortBy) {
            ...
            if (position > -1) {
                ...
                $sortIcon = $('<div data-role="sorticon" class="bt-unselectable" />').append(('desc' === direction) ? data.icons.desc : data.icons.asc);
    ...
    startLoading: function ($grid) {
        ...
        $loading = $('<div data-role="loading-text">' + bt.grid.messages[data.locale].Loading + '</div>').addClass(data.style.loadingText);
...
bt.grid.widget = function ($grid, jsConfig) {
     ...
     * <button id="btnClear" class="bt-button-md">Clear</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid = $('#grid').grid({
     ...
     * <button class="bt-button-md" id="btnDestroy">Destroy</button>
     * <button class="bt-button-md" id="btnCreate">Create</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     ...
     * <button class="bt-button-md" id="btnRemove">Remove</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid = $('#grid').grid({
     ...
     * <button id="btnSelect" class="bt-button-md">Select</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid = $('#grid').grid({
     ...
     * @return string
     * @example sample <!-- checkbox, grid -->
     * <button id="btnShowSelection" class="bt-button-md">Show Selection</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid = $('#grid').grid({
     ...
     * <button id="btnShowSelection" class="bt-button-md">Show Selections</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid, data = [
     ...
     * @return grid
     * @example sample <!-- checkbox, grid -->
     * <button id="btnSelectAll" class="bt-button-md">Select All</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid = $('#grid').grid({
     ...
     * @example sample <!-- checkbox, grid -->
     * <button id="btnSelectAll" class="bt-button-md">Select All</button>
     * <button id="btnUnSelectAll" class="bt-button-md">UnSelect All</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid = $('#grid').grid({
     ...
     * @return object
     * @example sample <!-- grid -->
     * <button id="btnGetData" class="bt-button-md">Get Data</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid = $('#grid').grid({
     ...
     * @return grid
     * @example sample <!-- grid -->
     * <button id="btnShowColumn" class="bt-button-md">Show Column</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid = $('#grid').grid({
     ...
     * @return grid
     * @example sample <!-- grid -->
     * <button id="btnHideColumn" class="bt-button-md">Hide Column</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid = $('#grid').grid({
     ...
     * <button id="btnAdd" class="bt-button-md">Add Row</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid = $('#grid').grid({
     ...
     *             { field: 'Name' },
     *             { field: 'PlaceOfBirth' },
     *             { width: 100, align: 'center', tmpl: '<u class="bt-cursor-pointer">Delete</u>', events: { 'click': Delete } }
     *         ]
     *     });
     * </script>
     * @example With.Pagination <!-- grid, dropdown -->
...
bt.grid.plugins.expandCollapseRows = {
    config: {
        base: {
            ...
            icons: {
                 ...
                 * @type String
                 * @default '<i class="bt-icon chevron-right" />'
                 ...
                 * </script>
                 */
                expandRow: '<i class="bt-icon chevron-right" />',

                /** Collapse row icon definition.
                 * @alias icons.collapseRow
                 * @type String
                 * @default '<i class="bt-icon chevron-down" />'
                 * @example Plus.Minus.Icons <!-- materialicons, grid -->
                 * <table id="grid"></table>
                 * <script>
                 *     $('#grid').grid({
                 ...
                 * </script>
                 */
                collapseRow: '<i class="bt-icon chevron-down" />'
            }
        },
    ...
    'private': {
        expandDetail: function ($grid, $cell, id) {
            var $contentRow = $cell.closest('tr'),
                ...
                $detailsCell = $('<td colspan="' + bt.grid.methods.countVisibleColumns($grid) + '" />'),
    ...
    'public': {
         ...
         * @example Sample <!-- grid -->
         * <button onclick="grid.expandAll()" class="bt-button-md">Expand All</button>
         * <button onclick="grid.collapseAll()" class="bt-button-md">Collapse All</button>
         * <br/><br/>
         * <table id="grid"></table>
         * <script>
         *     var grid = $('#grid').grid({
...
bt.grid.plugins.inlineEditing.config = {
    base: {
        ...
        inlineEditing: {
             ...
             *     editManager = function (value, record, $cell, $displayEl, id, $grid) {
             *         var data = $grid.data(),
             *             $edit = $('<button class="bt-button-md"><i class="material-icons">mode_edit</i> Edit</button>').attr('data-key', id),
             *             $delete = $('<button class="bt-button-md"><i class="material-icons">delete</i> Delete</button>').attr('data-key', id),
             *             $update = $('<button class="bt-button-md"><i class="material-icons">check_circle</i> Update</button>').attr('data-key', id).hide(),
             *             $cancel = $('<button class="bt-button-md"><i class="material-icons">cancel</i> Cancel</button>').attr('data-key', id).hide();
             *         $edit.on('click', function (e) {
...
bt.grid.plugins.inlineEditing.private = {
    localization: function (data) {
        if (data.uiLibrary === 'bootstrap') {
            data.inlineEditing.editButton = '<button role="edit" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> ' + bt.grid.messages[data.locale].Edit + '</button>';
            data.inlineEditing.deleteButton = '<button role="delete" class="btn btn-default btn-sm bt-margin-left-10"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> ' + bt.grid.messages[data.locale].Delete + '</button>';
            data.inlineEditing.updateButton = '<button role="update" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> ' + bt.grid.messages[data.locale].Update + '</button>';
            data.inlineEditing.cancelButton = '<button role="cancel" class="btn btn-default btn-sm bt-margin-left-10"><span class="glyphicon glyphicon-ban-circle" aria-hidden="true"></span> ' + bt.grid.messages[data.locale].Cancel + '</button>';
        } else {
            data.inlineEditing.editButton = '<button role="edit" class="bt-button-md"><i class="bt-icon pencil" /> ' + bt.grid.messages[data.locale].Edit.toUpperCase() + '</button>';
            data.inlineEditing.deleteButton = '<button role="delete" class="bt-button-md"><i class="bt-icon delete" /> ' + bt.grid.messages[data.locale].Delete.toUpperCase() + '</button>';
            data.inlineEditing.updateButton = '<button role="update" class="bt-button-md"><i class="bt-icon check-circle" /> ' + bt.grid.messages[data.locale].Update.toUpperCase() + '</button>';
            data.inlineEditing.cancelButton = '<button role="cancel" class="bt-button-md"><i class="bt-icon cancel" /> ' +bt.grid.messages[data.locale].Cancel.toUpperCase() + '</button>';
        }
    },
                ...
                if ($editorField.length) {
                    ...
                    if (typeof (column.editor) === 'function') {
                        ...
                        if ('checkbox' === column.type && bt.checkbox) {
                            ...
                            $editorField = $('<input type="text" value="' + value + '" class="bt-width-full"/>');
                ...
                if (cancel !== true && newValue !== record[column.field]) {
                    ...
                    if (column.mode !== 'editOnly') {
                        ...
                        if ($cell.find('span.bt-dirty').length === 0) {
                            $cell.prepend($('<span class="bt-dirty" />'));
                        }
                    }
...
bt.grid.plugins.inlineEditing.public = {
     ...
     * <button id="btnGetChanges" class="bt-button-md">Get Changes</button>
     * <br/><br/>
     * <table id="grid"></table>
     * <script>
     *     var grid = $('#grid').grid({
     ...
     *         var $editBtn = $('<i class="fa fa-pencil bt-cursor-pointer" data-key="' + id + '"></i>'),
     *             $updateBtn = $('<i class="fa fa-save bt-cursor-pointer" data-key="' + id + '"></i>').hide();
     ...
     *     renderer = function (value, record, $cell, $displayEl, id) {
     *         var $editBtn = $('<i class="fa fa-pencil bt-cursor-pointer" data-key="' + id + '"></i>'),
     *             $cancelBtn = $('<i class="fa fa-undo bt-cursor-pointer" data-key="' + id + '"></i>').hide();
     *         $editBtn.on('click', function (e) {
     *             grid.edit($(this).data('key'));
     *             $editBtn.hide();
     *             $cancelBtn.show();
...
bt.grid.plugins.pagination = {
    config: {
        base: {
            ...
            pager: {
                 ...
                 * table.bt-grid div[data-role="display"] div.custom-item { display: table; margin-right: 5px; }
                 * </style>
                 * <table id="grid"></table>
                 * <script>
                 *     var grid = $('#grid').grid({
        ...
        materialicons: {
            icons: {
                first: '<i class="bt-icon first-page" />',
                previous: '<i class="bt-icon chevron-left" />',
                next: '<i class="bt-icon chevron-right" />',
                last: '<i class="bt-icon last-page" />',
                refresh: '<i class="bt-icon refresh" />'
            }
        },
    ...
    private: {
        ...
        localizationBootstrap4: function (data) {
            ...
            if (typeof (data.pager.leftControls) === 'undefined') {
                data.pager.leftControls = [
                    $('<button class="btn btn-default btn-sm bt-cursor-pointer">' + (data.icons.first || msg.First) + '</button>').attr('title', msg.FirstPageTooltip).attr('data-role', 'page-first'),
                    $('<button class="btn btn-default btn-sm bt-cursor-pointer">' + (data.icons.previous || msg.Previous) + '</button>').attr('title', msg.PreviousPageTooltip).attr('data-role', 'page-previous'),
                    $('<div>' + msg.Page + '</div>'),
                    $('<div class="input-group"><input data-role="page-number" class="form-control form-control-sm" type="text" value="0"></div>'),
                    $('<div>' + msg.Of + '</div>'),
                    $('<div data-role="page-label-last">0</div>'),
                    $('<button class="btn btn-default btn-sm bt-cursor-pointer">' + (data.icons.next || msg.Next) + '</button>').attr('title', msg.NextPageTooltip).attr('data-role', 'page-next'),
                    $('<button class="btn btn-default btn-sm bt-cursor-pointer">' + (data.icons.last || msg.Last) + '</button>').attr('title', msg.LastPageTooltip).attr('data-role', 'page-last'),
                    $('<button class="btn btn-default btn-sm bt-cursor-pointer">' + (data.icons.refresh || msg.Refresh) + '</button>').attr('title', msg.Refresh).attr('data-role', 'page-refresh'),
                    $('<select data-role="page-size" class="form-control input-sm" width="60"></select>')
                ];
            }
            if (typeof (data.pager.rightControls) === 'undefined') {
        ...
        localizationMaterialDesign: function (data) {
            ...
            if (typeof (data.pager.rightControls) === 'undefined') {
                data.pager.rightControls = [
                    ...
                    $('<select data-role="page-size" class="bt-grid-md-limit-select" width="52"></select></div>'),
                    $('<span class="bt-md-spacer-32">&nbsp;</span>'),
                    $('<span data-role="record-first" class="">0</span>'),
                    $('<span class="">-</span>'),
                    $('<span data-role="record-last" class="">0</span>'),
                    $('<span class="bt-grid-mdl-pager-label">' + msg.Of + '</span>'),
                    $('<span data-role="record-total" class="">0</span>'),
                    $('<span class="bt-md-spacer-32">&nbsp;</span>'),
                    $('<button class="bt-button-md">' + (data.icons.previous || msg.Previous) + '</button>').attr('title', msg.PreviousPageTooltip).attr('data-role', 'page-previous').addClass(data.icons.first ? 'bt-button-md-icon' : ''),
                    $('<span class="bt-md-spacer-24">&nbsp;</span>'),
                    $('<button class="bt-button-md">' + (data.icons.next || msg.Next) + '</button>').attr('title', msg.NextPageTooltip).attr('data-role', 'page-next').addClass(data.icons.first ? 'bt-button-md-icon' : '')
                ];
            }
        },
...
bt.grid.plugins.responsiveDesign = {
    ...
    'public': {
         ...
         * @return grid object
         * @example sample <!-- grid -->
         * <button onclick="grid.makeResponsive()" class="bt-button-md">Make Responsive</button>
         * <br/><br/>
         * <table id="grid"></table>
         * <script>
         *     var grid = $('#grid').grid({
...
bt.grid.plugins.toolbar = {
    ...
    public: {        
         ...
         * <button onclick="grid.title('New Title')" class="bt-button-md">Set New Title</button>
         * <button onclick="alert(grid.title())" class="bt-button-md">Get Title</button>
         * <br/><br/>
         * <table id="grid"></table>
         * <script>
         *     var grid = $('#grid').grid({
        ...
        init: function ($grid, config) {
            ...
            if ($columns.length) {
                for (i = 0; i < $columns.length - 1; i++) {
                    $column = $($columns[i]);
                    $wrapper = $('<div class="bt-grid-column-resizer-wrapper" />');
                    marginRight = parseInt($column.css('padding-right'), 10) + 3;
                    $resizer = $('<span class="bt-grid-column-resizer" />').css('margin-right', '-' + marginRight + 'px');
                    $resizer.draggable({
                        start: function () {
...
bt.grid.plugins.rowReorder = {
    config: {
        base: {
             ...
             * <button onclick="alert(JSON.stringify(grid.getAll()))" class="bt-button-md">Show Data</button><br/><br/>
             * <table id="grid"></table>
             * <script>
             *     var data = [
             *         { 'ID': 1, 'OrderNumber': 1, 'Name': 'Hristo Stoichkov', 'PlaceOfBirth': 'Plovdiv, Bulgaria' },
...
bt.grid.plugins.export = {
    ...
    public: {
         ...
         * @return string
         * @example Local.Data <!-- grid, dropdown -->
         * <button onclick="alert(grid.getCSV(true))" class="bt-button-md">Get All</button>
         * <br/><br/>
         * <table id="grid"></table>
         * <script>
         *     var data, grid;
         ...
         * </script>
         * @example Remote.Data <!-- grid, dropdown -->
         * <button onclick="alert(grid.getCSV())" class="bt-button-md">Get CSV</button>
         * <br/><br/>
         * <table id="grid"></table>
         * <script>
         *     var grid = $('#grid').grid({
         ...
         * @return grid object
         * @example Local.Data <!-- grid, dropdown -->
         * <button onclick="grid.downloadCSV()" class="bt-button-md">Download Only First Page</button>
         * <button onclick="grid.downloadCSV('myfilename.csv', true)" class="bt-button-md">Download All Data</button>
         * <br/><br/>
         * <table id="grid"></table>
         * <script>
         *     var data, grid;
         ...
         * </script>
         * @example Remote.Data <!-- grid, dropdown -->
         * <button onclick="grid.downloadCSV('myfilename.csv')" class="bt-button-md">Download CSV</button>
         * <br/><br/>
         * <table id="grid"></table>
         * <script>
         *     var grid = $('#grid').grid({
        ...
        init: function ($grid) {
            ...
            for (i = 0; i < data.columns.length; i++) {
                ...
                if (data.columns[i].filterable) {
                    $ctrl = $('<input data-field="' + data.columns[i].field + '" class="bt-width-full" />');
    ...
    config: {
        base: {
            ...
            icons: {
                 ...
                 * </script>
                 */
                expandGroup: '<i class="bt-icon plus" />',

                /** Collapse row icon definition.
                 * @alias icons.collapseGroup
                 * @type String
                 * @default '<i class="bt-icon minus" />'
                 * @example Right.Down.Icons <!-- materialicons, grid -->
                 * <table id="grid"></table>
                 * <script>
                 *     $('#grid').grid({
                 ...
                 * </script>
                 */
                collapseGroup: '<i class="bt-icon minus" />'
            }
        },
            ...
            $grid.on('rowDataBound', function (e, $row, id, record) {
                if (previousValue !== record[data.grouping.groupBy] || $row[0].rowIndex === 1) {
                    var colspan = bt.grid.methods.countVisibleColumns($grid) - 1,
                        ...
                        $expandCollapseCell = $('<td class="bt-text-align-center bt-unselectable bt-cursor-pointer" />');
...
bt.tree.config = {
    base: {
        ...
        icons: {
             ...
             * </script>
             */
            expand: '<i class="bt-icon chevron-right" />',
             ...
             * </script>
             */
            collapse: '<i class="bt-icon chevron-down" />'
        }
    },
    ...
    bootstrap4: {
        ...
        icons: {
            expand: '<i class="bt-icon plus" />',
            collapse: '<i class="bt-icon minus" />'
        }
    },
...
bt.tree.events = {
     ...
     * <button id="reload" class="bt-button-md">Reload</button>
     * <div id="tree"></div>
     * <script>
     *     var tree = $('#tree').tree({
     *         dataSource: '/Locations/Get',
     ...
     * @param {object} node - the node as jquery object
     * @example Event.Sample <!-- tree -->
     * <button onclick="tree.enable(northAmerica, false)" class="bt-button-md">Enable North America</button>
     * <button onclick="tree.disable(northAmerica, false)" class="bt-button-md">Disable North America</button>
     * <br/><br/>
     * <div id="tree" data-source="/Locations/Get"></div>
     * <script>
     ...
     * @param {object} e - event data
     * @example Event.Sample <!-- tree -->
     * <button onclick="tree.destroy()" class="bt-button-md">Destroy</button>
     * <br/><br/>
     * <div id="tree" data-source="/Locations/Get"></div>
     * <script>
     *     var tree = $('#tree').tree();
...
bt.tree.methods = {
    ...
    appendNode: function ($tree, $parent, nodeData, level, position) {
        ...
        if (nodeData.children.length || hasChildren) {
            ...
            $newParent = $('<ul />').addClass(data.style.list).addClass('bt-hidden');
...
bt.tree.widget = function ($element, jsConfig) {
     ...
     * <button onclick="tree.reload()" class="bt-button-md">Click to load</button>
     * <br/><br/>
     * <div id="tree"></div>
     * <script>
     *     var tree = $('#tree').tree({
     ...
     * <button onclick="append()" class="bt-button-md">Append To Root</button>
     * <br/>
     * <div id="tree" data-source="/Locations/Get"></div>
     * <script>
     *     var tree = $('#tree').tree();
     ...
     * <button onclick="append()" class="bt-button-md">Append To Asia</button>
     * <br/>
     * <div id="tree" data-source="/Locations/Get"></div>
     * <script>
     ...
     * <button onclick="append()" class="bt-button-md">Prepend in Asia</button>
     * <br/>
     * <div id="tree" data-source="/Locations/Get"></div>
     * <script>
     *     var parent, tree = $('#tree').tree();
     ...
     * <button onclick="append()" class="bt-button-md">Append to Asia as second</button>
     * <br/>
     * <div id="tree" data-source="/Locations/Get"></div>
     * <script>
     *     var parent, tree = $('#tree').tree();
     ...
     * @return jQuery object
     * @example Method.Sample <!-- tree -->
     * <button onclick="remove()" class="bt-button-md">Remove USA</button>
     * <br/>
     * <div id="tree"></div>
     * <script>
     *     var tree = $('#tree').tree({
     ...
     * <button onclick="save()" class="bt-button-md">Save</button>
     * <br/>
     * <div id="tree"></div>
     * <script>
     *     var tree = $('#tree').tree({
     ...
     * @return jQuery object
     * @example Method.Sample <!-- tree -->
     * <button onclick="expand()" class="bt-button-md">Expand Asia</button>
     * <button onclick="collapse()" class="bt-button-md">Collapse Asia</button>
     * <br/>
     * <div id="tree"></div>
     * <script>
     *     var tree = $('#tree').tree({
     ...
     * <button onclick="expand()" class="bt-button-md">Expand North America</button>
     * <br/>
     * <div id="tree"></div>
     * <script>
     *     var tree = $('#tree').tree({
     ...
     * </script>
     * @example Cascade <!-- tree -->
     * <button onclick="collapse()" class="bt-button-md">Collapse North America</button>
     * <br/>
     * <div id="tree"></div>
     * <script>
     *     var tree = $('#tree').tree({
     ...
     * @return jQuery object
     * @example Sample <!-- tree -->
     * <button onclick="tree.expandAll()" class="bt-button-md">Expand All</button>
     * <button onclick="tree.collapseAll()" class="bt-button-md">Collapse All</button>
     * <br/>
     * <div id="tree" data-source="/Locations/Get"></div>
     * <script>
     *     var tree = $('#tree').tree();
     ...
     * @return Array
     * @example sample <!-- tree -->
     * <button onclick="alert(JSON.stringify(tree.getAll()))" class="bt-button-md">Get All Data</button>
     * <button onclick="tree.addNode({ text: 'New Node' });" class="bt-button-md">Add New Node</button>
     * <br/>
     * <div id="tree"></div>
     * <script>
     *     var tree = $('#tree').tree({
     ...
     * <button onclick="tree.select(northAmerica)" class="bt-button-md">Select North America</button>
     * <button onclick="tree.unselect(northAmerica)" class="bt-button-md">Unselect North America</button>
     * <br/>
     * <div id="tree" data-source="/Locations/Get"></div>
     * <script>
     *     var tree, northAmerica;
     ...
     * @return jQuery object
     * @example Sample <!-- tree -->
     * <button onclick="tree.selectAll()" class="bt-button-md">Select All</button>
     * <button onclick="tree.unselectAll()" class="bt-button-md">Unselect All</button>
     * <br/>
     * <div id="tree" data-source="/Locations/Get"></div>
     * <script>
     *     var tree = $('#tree').tree({
     ...
     * <button onclick="tree.enable(northAmerica)" class="bt-button-md">Enable North America (Cascade)</button>
     * <button onclick="tree.disable(northAmerica)" class="bt-button-md">Disable North America (Cascade)</button>
     * <button onclick="tree.enable(northAmerica, false)" class="bt-button-md">Enable North America (Non-Cascade)</button>
     * <button onclick="tree.disable(northAmerica, false)" class="bt-button-md">Disable North America (Non-Cascade)</button>
     * <br/>
     * <div id="tree" data-source="/Locations/Get"></div>
     * <script>
     *     var tree, northAmerica;
     ...
     * <button onclick="tree.enableAll()" class="bt-button-md">Enable All</button>
     * <button onclick="tree.disableAll()" class="bt-button-md">Disable All</button>
     * <br/>
     * <div id="tree" data-source="/Locations/Get"></div>
     * <script>
     *     var tree = $('#tree').tree({
...
bt.tree.plugins.checkboxes = {
    ...
    public: {
         ...
         * <button id="btnGet" class="bt-button-md">Get Checked Nodes</button>
         * <div id="tree"></div>
         * <script>
         *     var tree = $('#tree').tree({
         *         dataSource: '/Locations/Get',
         ...
         * @example Sample <!-- checkbox, tree -->
         * <button onclick="tree.checkAll()" class="bt-button-md">Check All</button>
         * <button onclick="tree.uncheckAll()" class="bt-button-md">Uncheck All</button>
         * <br/><br/>
         * <div id="tree" data-source="/Locations/Get"></div>
         * <script>
         *     var tree = $('#tree').tree({
         ...
         * @return tree as jQuery object
         * @example Sample <!-- checkbox, tree -->
         * <button onclick="tree.check(tree.getNodeByText('China'))" class="bt-button-md">Check China</button>
         * <br/>
         * <div id="tree" data-source="/Locations/Get"></div>
         * <script>
         *     var tree = $('#tree').tree({
         ...
         * @return tree as jQuery object
         * @example Sample <!-- checkbox, tree -->
         * <button onclick="tree.uncheck(tree.getNodeByText('China'))" class="bt-button-md">UnCheck China</button>
         * <br/>
         * <div id="tree" data-source="/Locations/Get"></div>
         * <script>
         *     var tree = $('#tree').tree({
...
bt.checkbox.config = {
    base: {
         ...
         * <button onclick="$chkb.state('checked')" class="bt-button-md">Checked</button>
         * <button onclick="$chkb.state('unchecked')" class="bt-button-md">Unchecked</button>
         * <button onclick="$chkb.state('indeterminate')" class="bt-button-md">Indeterminate</button>
         * <button onclick="$chkb.prop('disabled', false)" class="bt-button-md">Enable</button>
         * <button onclick="$chkb.prop('disabled', true)" class="bt-button-md">Disable</button>
         * <script>
...
bt.checkbox.widget = function ($element, jsConfig) {
     ...
     * @example sample <!-- checkbox -->
     * <button onclick="$chkb.toggle()" class="bt-button-md">toggle</button>
     * <hr/>
     * <input type="checkbox" id="checkbox"/>
     * <script>
     *     var $chkb = $('#checkbox').checkbox();
     ...
     * @example sample <!-- checkbox -->
     * <button onclick="$chkb.state('checked')" class="bt-button-md">Set to checked</button>
     * <button onclick="$chkb.state('unchecked')" class="bt-button-md">Set to unchecked</button>
     * <button onclick="$chkb.state('indeterminate')" class="bt-button-md">Set to indeterminate</button>
     * <button onclick="alert($chkb.state())" class="bt-button-md">Get state</button>
     * <hr/>
     * <input type="checkbox" id="checkbox"/>
     * <script>
     *     var $chkb = $('#checkbox').checkbox();
     ...
     * @return checkbox as jquery object
     * @example sample <!-- checkbox -->
     * <button onclick="$chkb.destroy()" class="bt-button-md">Destroy</button>
     * <input type="checkbox" id="checkbox"/>
     * <script>
     *     var $chkb = $('#checkbox').checkbox();
     * </script>
...
bt.editor.config = {
    ...
    materialicons: {
        icons: {
            bold: '<i class="bt-icon bold" />',
            italic: '<i class="bt-icon italic" />',
            strikethrough: '<i class="bt-icon strikethrough" />',
            underline: '<i class="bt-icon underlined" />',

            listBulleted: '<i class="bt-icon list-bulleted" />',
            listNumbered: '<i class="bt-icon list-numbered" />',
            indentDecrease: '<i class="bt-icon indent-decrease" />',
            indentIncrease: '<i class="bt-icon indent-increase" />',

            alignLeft: '<i class="bt-icon align-left" />',
            alignCenter: '<i class="bt-icon align-center" />',
            alignRight: '<i class="bt-icon align-right" />',
            alignJustify: '<i class="bt-icon align-justify" />',

            undo: '<i class="bt-icon undo" />',
            redo: '<i class="bt-icon redo" />'
        }
    },
...
bt.editor.widget = function ($element, jsConfig) {
     ...
     * <button class="bt-button-md" onclick="alert($editor.content())">Get Content</button>
     * <hr/>
     ...
     * <button class="bt-button-md" onclick="$editor.content('<h1>new value</h1>')">Set Content</button>
     * <hr/>
     * <textarea id="editor"></textarea>
     * <script>
     *     var $editor = $('#editor').editor();
     ...
     * <button class="bt-button-md" onclick="editor.destroy()">Destroy</button><br/>
     * <textarea id="editor"></textarea>
     * <script>
     *     var editor = $('#editor').editor();
     * </script>
...
bt.dropdown.config = {
    base: {
         ...
         * </script>
         * @example HTML.Config <!-- dropdown -->
         * <input type="text" class="bt-textbox-md" placeholder="Select One..." style="width: 200px" /><br/>
        ...
        icons: {
             ...
             * @type String
             * @default '<i class="bt-icon arrow-dropdown" />'
             ...
             * </script>
             */
            dropdown: '<i class="bt-icon arrow-dropdown" />',

            dropup: '<i class="bt-icon arrow-dropup" />'
        },
...
bt.dropdown.widget = function ($element, jsConfig) {
     ...
     * <button class="bt-button-md" onclick="alert($dropdown.value())">Get Value</button>
     * <hr/>
     * <select id="dropdown" width="200">
     *     <option value="1">One</option>
     *     <option value="2" selected>Two</option>
     ...
     * <button class="bt-button-md" onclick="$dropdown.value('3')">Set Value</button>
     * <hr/>
     * <select id="dropdown" width="200">
     *     <option value="1">One</option>
     *     <option value="2" selected>Two</option>
     ...
     * @return jquery element
     * @example sample <!-- dropdown, materialicons -->
     * <button class="bt-button-md" onclick="dropdown.destroy()">Destroy</button>
     * <select id="dropdown" width="200">
     *     <option value="1">One</option>
     *     <option value="2" selected>Two</option>
     *     <option value="3">Three</option>
...
bt.datepicker.config = {
    base: {
        ...
        icons: {
             ...
             * </script>
             */
            rightIcon: '<i class="bt-icon">event</i>',

            previousMonth: '<i class="bt-icon chevron-left"></i>',
            nextMonth: '<i class="bt-icon chevron-right"></i>'
        },
...
bt.datepicker.methods = {
    ...
    createCalendar: function ($datepicker, data) {
        ...
        if (data.footer) {
            ...
            $btnCancel = $('<button class="' + data.style.button + '">' + bt.core.messages[data.locale].cancel + '</button>');
            $btnCancel.on('click', function () { $datepicker.close(); });
            $footer.append($btnCancel);

            $btnOk = $('<button class="' + data.style.button + '">' + bt.core.messages[data.locale].ok + '</button>');
    ...
    createNavigation: function ($datepicker, $body, $table, data) {
        ...
        $navigator.append($('<div>' + data.icons.previousMonth + '</div>').on('click', bt.datepicker.methods.prev($datepicker, data)));
        $navigator.append($('<div role="period"></div>').on('click', bt.datepicker.methods.changePeriod($datepicker, data)));
        $navigator.append($('<div>' + data.icons.nextMonth + '</div>').on('click', bt.datepicker.methods.next($datepicker, data)));
        ...
        for (i = data.weekStartDay; i < bt.core.messages[data.locale].weekDaysMin.length; i++) {
            $row.append('<th><div>' + bt.core.messages[data.locale].weekDaysMin[i] + '</div></th>');
        }
    ...
    renderMonth: function ($datepicker, $calendar, data) {
        ...
        for (i = 1; i <= firstDayPosition; i++) {
            ...
            if (data.calendarWeeks && i === 1) {
                $row.append('<td class="calendar-week"><div>' + bt.datepicker.methods.getWeekNumber(date) + '</div></td>');
            }
    ...
    renderYear: function ($datepicker, $calendar, data) {
        ...
        for (i = 0; i < 3; i++) {
            $row = $('<tr />');
            for (m = (i * 4); m <= (i * 4) + 3; m++) {
                $month = $('<div>' + bt.core.messages[data.locale].monthShortNames[m] + '</div>');
...
bt.datepicker.widget = function ($element, jsConfig) {
     ...
     * <button class="bt-button-md" onclick="alert($datepicker.value())">Get Value</button>
     * <hr/>
     * <input id="datepicker" width="312" />
     * <script>
     *     var $datepicker = $('#datepicker').datepicker();
     ...
     * <button class="bt-button-md" onclick="$datepicker.value('08/01/2017')">Set Value</button>
     * <hr/>
     * <input id="datepicker" width="312" />
     * <script>
     *     var $datepicker = $('#datepicker').datepicker();
     ...
     * @return jquery element
     * @example sample <!-- datepicker -->
     * <button class="bt-button-md" onclick="datepicker.destroy()">Destroy</button>
     * <input id="datepicker" width="312" />
     * <script>
     *     var datepicker = $('#datepicker').datepicker();
     * </script>
     ...
     * <button class="bt-button-md" onclick="$datepicker.open()">Open</button>
     * <button class="bt-button-md" onclick="$datepicker.close()">Close</button>
     * <hr/>
     * <input id="datepicker" width="312" />
     * <script>
     *     var $datepicker = $('#datepicker').datepicker();
...
bt.timepicker.config = {
    base: {
        ...
        icons: {
            rightIcon: '<i class="bt-icon clock" />'
        },
...
bt.timepicker.methods = {
    ...
    createClock: function ($timepicker) {
        ...
        if (data.header) {
            ...
            if (data.mode === 'ampm') {
                $mode.append($('<span role="am">' + bt.core.messages[data.locale].am + '</span>').on('click', function () {
                ...
                $mode.append('<br />');
                $mode.append($('<span role="pm">' + bt.core.messages[data.locale].pm + '</span>').on('click', function () {
                    var hour = bt.timepicker.methods.getHour($clock);
                    $clock.attr('mode', 'pm');
                    $(this).addClass('selected');
...
bt.timepicker.widget = function ($element, jsConfig) {
     ...
     * <button class="bt-button-md" onclick="alert($timepicker.value())">Get Value</button>
     * <hr/>
     * <input id="timepicker" width="312" />
     * <script>
     *     var $timepicker = $('#timepicker').timepicker();
     ...
     * <button class="bt-button-md" onclick="$timepicker.value('11:00')">Set Value</button>
     * <hr/>
     * <input id="timepicker" width="312" />
     * <script>
     *     var $timepicker = $('#timepicker').timepicker();
     ...
     * @return jquery element
     * @example sample <!-- timepicker -->
     * <button class="bt-button-md" onclick="timepicker.destroy()">Destroy</button>
     * <input id="timepicker" width="312" />
     * <script>
     *     var timepicker = $('#timepicker').timepicker();
     * </script>
     ...
     * <button class="bt-button-md" onclick="$timepicker.open()">Open</button>
     * <button class="bt-button-md" onclick="$timepicker.close()">Close</button>
     * <hr/>
     * <input id="timepicker" width="312" />
     * <script>
...
bt.datetimepicker.methods = {
    ...
    initialize: function ($datetimepicker) {
        ...
        $calendarMode = $('<i class="bt-icon selected" role="calendarMode">event</i>');
        ...
        $time = $('<div role="time" />');
        $time.append($('<div role="hour" />').on('click', bt.datetimepicker.methods.createShowHourHandler($datetimepicker, $picker, data)).html(bt.core.formatDate(new Date(), 'HH', data.locale)));
        $time.append(':');
        $time.append($('<div role="minute" />').on('click', bt.datetimepicker.methods.createShowMinuteHandler($datetimepicker, $picker, data)).html(bt.core.formatDate(new Date(), 'MM', data.locale)));
        $switch.append($time);

        $clockMode = $('<i class="bt-icon" role="clockMode">clock</i>');
...
bt.datetimepicker.widget = function ($element, jsConfig) {
     ...
     * <button class="bt-button-md" onclick="alert($datetimepicker.value())">Get Value</button>
     * <hr/>
     ...
     * <button class="bt-button-md" onclick="$datetimepicker.value('13:40 08/01/2017')">Set Value</button>
     * <hr/>
     * <input id="datetimepicker" width="312" />
     * <script>
     *     var $datetimepicker = $('#datetimepicker').datetimepicker();
     ...
     * @return jquery element
     * @example sample <!-- datetimepicker -->
     * <button class="bt-button-md" onclick="datetimepicker.destroy()">Destroy</button>
     * <input id="datetimepicker" width="312" />
     * <script>
     *     var datetimepicker = $('#datetimepicker').datetimepicker();
     * </script>
...
bt.slider.widget = function ($element, jsConfig) {
     ...
     * @return string
     * @example Get <!-- slider -->
     * <button class="bt-button-md" onclick="alert($slider.value())">Get Value</button>
     * <hr/>
     * <input id="slider" width="300" />
     * <script>
     *     var $slider = $('#slider').slider();
     * </script>
     * @example Set <!-- slider -->
     * <button class="bt-button-md" onclick="$slider.value(77)">Set Value</button>
     * <hr/>
     * <input id="slider" width="300"  />
     * <script>
     *     var $slider = $('#slider').slider();
     ...
     * @return jquery element
     * @example sample <!-- slider -->
     * <button class="bt-button-md" onclick="slider.destroy()">Destroy</button>
     * <input id="slider" width="300" />
     * <script>
     *     var slider = $('#slider').slider();
     * </script>
